...
namespace HomaGames.HomaBelly {
    ...
    public static class DevelopmentModeWarningWindow {
        ...
        private static bool ShowWarningWindow {
            get => EditorPrefs.GetBool(DEVELOPMENT_MODE_SHOW_WARNING_PREF_KEY, true);
        ...
        private static void RegisterWarningWindowFilter() {
            BuildPlayerHandlerWrapper.AddBuildPlayerHandlerFilter(DevelopmentModeWarningFilter);
        }

        private static bool DevelopmentModeWarningFilter(BuildPlayerOptions options) {
