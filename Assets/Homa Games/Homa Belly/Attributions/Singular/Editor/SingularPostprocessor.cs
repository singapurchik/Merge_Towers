    ...
    public class SingularPostprocessor
    {
        ...
        public static void OnPostprocessBuild(BuildTarget buildTarget, string buildPath)
        {
            ...
            if (buildTarget == BuildTarget.iOS)
            {
                ...
                // Added for support to ioS 15
                // https://support.singular.net/hc/en-us/articles/4405749380379--NEW-How-to-Send-SKAdNetwork-Postbacks-to-Singular-iOS-15-
                iOSPlistUtils.SetRootStrings(buildTarget,
                    buildPath,
                    new[]
                    {
                        new KeyValuePair<string, string>("NSAdvertisingAttributionReportEndpoint",
                            "https://singular-bi.net")
                    });
